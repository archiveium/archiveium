...
describe('profileService', () => {
	describe('updatePassword', () => {
		...
		it('should throw error if passwords do not match', async () => {
			// arrange
			const hashedPassword =
				'1e3a7c3cece7f5cc58e5dcf1fcc6a1b4:7b01211c3acd31b68507414cd14f5b0170005293934f708dbd01b26c6e1c425213b993abf94c7de4f2a22604240195e0a3ee26f1776aab4218b322d77a89f590';
			const userId = 'user-id';
			const findUserByIdSpy = vi.spyOn(userService, 'findUserById');
			const updatePasswordByUserEmailSpy = vi.spyOn(userService, 'updatePasswordByUserEmail');
			const verifyUserPasswordSpy = vi.spyOn(authService, 'verifyUserPassword');
			...
			// act & assert
			await expect(profileService.updatePassword(userId, formData)).rejects.toThrow(
