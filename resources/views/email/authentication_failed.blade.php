...
<span class="preheader"
      style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">We couldn’t process your payment. Let’s get that fixed!</span>
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="email-body" width="570" cellpadding="0" cellspacing="0"
                        style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
                                ...
                                <td class="content-cell"
                                    ...
                                    <div class="f-fallback">
                                        ...
                                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">
                                            It appears that the password provided for syncing {{ $accountUsername }} has changed.
                                            This has resulted in your account being paused from syncing.
                                        </p>
                                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">
                                            Please take a moment to double-check and change your password. Once done, you can then
                                            re-enable syncing.</p>
                                        <!-- Action -->
                                                            ...
                                                            <td align="center"
                                                                ...
                                                                <a href="{{ route('dashboard') }}"
                                                                   ...
                                                                   style="color: #FFF; background-color: #22BC66; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box; border-color: #22BC66; border-style: solid; border-width: 10px 18px;">
                                                                    Update password for {{ $accountUsername }} →
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
