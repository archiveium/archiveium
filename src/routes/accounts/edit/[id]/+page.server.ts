...
import { DeleteAccountByAccountIdAndUserId, GetAccountByUserIdAndAccountId, UpdateAccount, ValidateExistingAccount } from '../../../../actions/account.js';
        ...
        try {
            switch (data.get('step')) {
                ...
                case 'addAccountStep2':
                    await UpdateAccount(userId, selectedAccount.email, selectedAccount.id, data.getAll('folders'));
                    await saveFlashMessage(locals.sessionId, {
                        type: 'success',
