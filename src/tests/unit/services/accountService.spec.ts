...
describe('accountService', () => {
    describe('findAccountByUserIdAndAccountId', () => {
        ...
        it('should return account with decrypted password', async () => {
            ...
            const findAccountByUserIdAndAccountIdSpy = vi.spyOn(accountRepository, 'findAccountByUserIdAndAccountId');
            findAccountByUserIdAndAccountIdSpy.mockResolvedValueOnce({
                email: 'test@email.com',
                id: '1234',
                name: 'test',
                password: '8ef92b4761339b98d692a2dd590f798199618bdcb5affee480c5156158f96ad6|35efeb854bc73c7f1e0802229175b2c8',
                provider_id: '1',
                user_id: '1',
                syncing: true,
                deleted: false,
        ...
        it('should throw an exception if decryption fails because of missing IV', async () => {
            ...
            // act & assert
            await expect(accountService.findAccountByUserIdAndAccountId('1', '2')).rejects.toThrow(DecryptException);
        });
        ...
        it('should throw exception if no results are found', async () => {
            ...
            // act & assert
            await expect(accountService.findAccountByUserIdAndAccountId('1', '2')).rejects.toThrow(AccountNotFoundException);
        });
    });
});